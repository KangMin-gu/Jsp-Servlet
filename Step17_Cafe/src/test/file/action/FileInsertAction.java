...
public class FileInsertAction extends Action{
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) {
		...
		*/
	    ...
	    //request로 부터 ServletContext 객체의 참조값 얻어오기  application은 jsp기본객체지만 여기는 jsp가 아니기때문에
	    //request를 써서 jsp에서  servlet으로 얻어온다.
		...
		return new ActionForward("/views/file/insert_result.jsp");
		//인서트된 결과값이 나오는  jsp화면으로 이동
	}
